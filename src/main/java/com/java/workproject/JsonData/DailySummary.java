...
public class DailySummary
{
    ...
    {
        return "ClassPojo [maxtempi = "+maxtempi+", minpressurei = "+minpressurei+", coolingdegreedays = "+coolingdegreedays+", meanpressurem = "+meanpressurem+", meandewpti = "+meandewpti+", maxtempm = "+maxtempm+", minpressurem = "+minpressurem+", mindewptm = "+mindewptm+", meandewptm = "+meandewptm+", mindewpti = "+mindewpti+", since1jancoolingdegreedaysnormal = "+since1jancoolingdegreedaysnormal+", gdegreedays = "+gdegreedays+", since1julheatingdegreedays = "+since1julheatingdegreedays+", since1sepcoolingdegreedays = "+since1sepcoolingdegreedays+", snow = "+snow+", minvism = "+minvism+", monthtodatesnowfalli = "+monthtodatesnowfalli+", monthtodateheatingdegreedays = "+monthtodateheatingdegreedays+", minvisi = "+minvisi+", monthtodatesnowfallm = "+monthtodatesnowfallm+", thunder = "+thunder+", precipi = "+precipi+", precipm = "+precipm+", meanvisi = "+meanvisi+", maxvism = "+maxvism+", humidity = "+humidity+", maxvisi = "+maxvisi+", meanvism = "+meanvism+", meanpressurei = "+meanpressurei+", maxhumidity = "+maxhumidity+", monthtodateheatingdegreedaysnormal = "+monthtodateheatingdegreedaysnormal+", meantempi = "+meantempi+", minwspdi = "+minwspdi+", meantempm = "+meantempm+", maxwspdm = "+maxwspdm+", heatingdegreedays = "+heatingdegreedays+", maxwspdi = "+maxwspdi+", maxpressurem = "+maxpressurem+", date = "+date+", minwspdm = "+minwspdm+", maxpressurei = "+maxpressurei+", mintempm = "+mintempm+", maxdewpti = "+maxdewpti+", mintempi = "+mintempi+", maxdewptm = "+maxdewptm+", monthtodatecoolingdegreedaysnormal = "+monthtodatecoolingdegreedaysnormal+", rain = "+rain+", monthtodatecoolingdegreedays = "+monthtodatecoolingdegreedays+", hail = "+hail+", meanwindspdi = "+meanwindspdi+", snowfalli = "+snowfalli+", since1sepcoolingdegreedaysnormal = "+since1sepcoolingdegreedaysnormal+", snowfallm = "+snowfallm+", precipsource = "+precipsource+", since1julsnowfalli = "+since1julsnowfalli+", since1sepheatingdegreedays = "+since1sepheatingdegreedays+", heatingdegreedaysnormal = "+heatingdegreedaysnormal+", since1julheatingdegreedaysnormal = "+since1julheatingdegreedaysnormal+", fog = "+fog+", since1jancoolingdegreedays = "+since1jancoolingdegreedays+", since1julsnowfallm = "+since1julsnowfallm+", snowdepthm = "+snowdepthm+", minhumidity = "+minhumidity+", coolingdegreedaysnormal = "+coolingdegreedaysnormal+", meanwdire = "+meanwdire+", meanwindspdm = "+meanwindspdm+", tornado = "+tornado+", snowdepthi = "+snowdepthi+", since1sepheatingdegreedaysnormal = "+since1sepheatingdegreedaysnormal+", meanwdird = "+meanwdird+"]";
    }
}
